...
export default function Righthome(props){
    return(
        <div className=" w-[31.25rem] pt-28 flex flex-col mr-12">
                ...
                <div className="flex flex-row justify-between ml-8 rounded-xl text-xl font-extrabold bg-gray-200 p-4 mr-2 w-52">
                    <button className="text-orange-400 mr-10" onClick={props.decrementCount}>-</button>
                    <p className="mr-10">{props.count}</p>
                    <button className="text-orange-400" onClick={props.incrementCount}>+</button>
                </div>
                <div className="flex flex-row mr-8 bg-orange-400 text-white  w-2/3 items-center text-xl justify-center rounded-xl hover:bg-[#69707D] hover:text-orange-400">
                    ...
                    <p onClick={props.handleClick} className="transition-transform duration-100 ease-in-out hover:translate-x-[-25px]">Add to cart</p>
                </div>
                </div>
            </div>
    )
